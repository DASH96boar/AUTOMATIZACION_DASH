...
RUTA_BASE_AGRICOLA = f"{ruta_base}/DATA/PELIGRO/INUNDACION_PLUVIAL/CUSCO_DEPARTAMENTO/DATOS_GENERALES/ELEMENTOS_EXPUESTOS/AGRICOLA"
RUTA_BASE_CP = f"{ruta_base}/DATA/PELIGRO/INUNDACION_PLUVIAL/CUSCO_DEPARTAMENTO/DATOS_GENERALES/ELEMENTOS_EXPUESTOS/CP"
RUTA_BASE_IE = f"{ruta_base}/DATA/PELIGRO/INUNDACION_PLUVIAL/CUSCO_DEPARTAMENTO/DATOS_GENERALES/ELEMENTOS_EXPUESTOS/IE"
RUTA_BASE_URBE = f"{ruta_base}/DATA/PELIGRO/INUNDACION_PLUVIAL/CUSCO_DEPARTAMENTO/DATOS_GENERALES/ELEMENTOS_EXPUESTOS/URBE"  # <<< AÑADIDO
