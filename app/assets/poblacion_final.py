# -*- coding: utf-8 -*-
"""poblacion_final.py - VERSIÓN CORREGIDA Y VISUALMENTE UNIFICADA"""
...
def cargar_centros_poblados():
    ...
    ruta_directa = f"{ruta_base}/DATA/CENTROS_POBLADOS/Centros_Poblados_INEI_geogpsperu_SuyoPomalia.shp"
...
# =========================================================================
# FUNCIÓN DE MAPA DE UBICACIÓN (VERSIÓN MEJORADA CON ETIQUETAS)
# =========================================================================
...
def generar_mapa_poblacion(nombre_usuario, departamento_sel, provincia_sel, distrito_sel):
    ...
    # --- INICIO DE MODIFICACIÓN: COLORES UNIFICADOS ---
    ...
    # --- INICIO DE MODIFICACIÓN: LEYENDA UNIFICADA Y LIMPIA ---
    legend_elements = [
    ...
    # Se eliminó la línea de 'Grillado UTM'
    # --- FIN DE MODIFICACIÓN ---
