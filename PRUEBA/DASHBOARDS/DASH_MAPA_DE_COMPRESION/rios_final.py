...
def generar_mapa_rios(nombre_usuario, departamento_sel, provincia_sel, distrito_sel, 
    ...
    try:
        gdf_paises = gpd.read_file(f"{ruta_base}/DATA/MAPA_DE_UBICACION/PAISES_DE_SUDAMERICA/Sudamerica.shp").to_crs(3857)
        gdf_oceano = gpd.read_file(f"{ruta_base}/DATA/MAPA_DE_UBICACION/OCEANO/Oceano.shp").to_crs(3857)
    except Exception as e:
