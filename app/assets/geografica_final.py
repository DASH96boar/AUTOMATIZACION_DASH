...
def cargar_lagos():
    ...
    ruta_lagos = f"{ruta_base}/DATA/MAPA_DE_UBICACION/LAGOS/Lago_y_Laguna_IGN_IDEP_geogpsperu_SuyoPomalia.shp"
...
def generar_mapa_final(nombre_usuario, departamento_sel, provincia_sel, distrito_sel):
    ...
    posibles_paises = [
        f"{ruta_base}/DATA/MAPA_DE_UBICACION/PAISES_DE_SUDAMERICA/Sudamérica.shp",
        f"{ruta_base}/DATA/MAPA_DE_UBICACION/PAISES/Sudamérica.shp",
        f"{ruta_base}/DATA/PAISES_DE_SUDAMERICA/Sudamérica.shp"
    ]
    ...
    posibles_oceano = [
        f"{ruta_base}/DATA/MAPA_DE_UBICACION/OCEANO/Océano.shp",
        f"{ruta_base}/DATA/OCEANO/Océano.shp",
        f"{ruta_base}/DATA/MAPA_DE_UBICACION/OCEANO/oceano.shp"
    ]
...
def generar_mapa_elementos_expuestos(nombre_usuario, departamento_sel, provincia_sel, distrito_sel):
    """
    Alias para generar_mapa_final - mantiene compatibilidad con app.py
    """
    return generar_mapa_final(nombre_usuario, departamento_sel, provincia_sel, distrito_sel)
